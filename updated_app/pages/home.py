...
layout = html.Div(children=[
    ...
    dcc.Markdown("""
        ...
        So, indicators of Scam PACs include:
                 ...
                 * A disproportionate amount of spending to vendors related to fundraising or direct mail services, or consultants
    ...
    dcc.Markdown("""
        ...
        * Named entity resolution to link vendor names to corporate registrations and expose shell company networks
        * Annual updates to incorporate future election cycles
        """),
